...
import persistmap.FileHashMap;
import persistmap.NestedException;
import persistmap.ObjectExistsException;
import persistmap.VersionMismatchException;
...
final class Entries {
	...
	Entries(){ 
		...
		this.entries = Collections
            ...
            {
                System.out.println("unable to create entry on node");
            }
	}
